	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case PiViM.diagram.edit.parts.IconsEditPart.VISUAL_ID:
				return new PiViM.diagram.edit.parts.IconsEditPart(view);

			case PiViM.diagram.edit.parts.CodeBlockEditPart.VISUAL_ID:
				return new PiViM.diagram.edit.parts.CodeBlockEditPart(view);

			case PiViM.diagram.edit.parts.CodeBlockNameEditPart.VISUAL_ID:
				return new PiViM.diagram.edit.parts.CodeBlockNameEditPart(view);

			case PiViM.diagram.edit.parts.ConnectorEditPart.VISUAL_ID:
				return new PiViM.diagram.edit.parts.ConnectorEditPart(view);
