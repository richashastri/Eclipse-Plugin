...
/**
 * This is the item provider adapter for a {@link asu.ser.capstone.pivi.InputPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputPort_statement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPort_statement_feature", "_UI_InputPort_type"),
				 PiviPackage.Literals.INPUT_PORT__STATEMENT,
				 true,
				 false,
				 true,
				 null,
