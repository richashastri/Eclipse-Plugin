 ...
 * @generated
 */
public class CodeBlockNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CodeBlockNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new CodeBlockMM.diagram.edit.policies.CodeBlockTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CodeBlockMM.diagram.providers.CodeBlockElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CodeBlockMM.diagram.providers.CodeBlockParserProvider.getParser(
					CodeBlockMM.diagram.providers.CodeBlockElementTypes.CodeBlock_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					CodeBlockMM.diagram.edit.parts.CodeBlockEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
