...
public class MethodStartCompartmentFigureListener implements FigureListener {
	...
	public MethodStartCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
