...
public class SyncStartCompartmentFigureListener implements FigureListener {
	...
	public SyncStartCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
