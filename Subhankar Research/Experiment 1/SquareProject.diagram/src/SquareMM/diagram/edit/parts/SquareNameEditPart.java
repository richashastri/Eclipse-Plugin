 ...
 * @generated
 */
public class SquareNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SquareNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SquareMM.diagram.edit.policies.SquareTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return SquareMM.diagram.providers.SquareElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SquareMM.diagram.providers.SquareParserProvider.getParser(
					SquareMM.diagram.providers.SquareElementTypes.Square_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					SquareMM.diagram.edit.parts.SquareEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
