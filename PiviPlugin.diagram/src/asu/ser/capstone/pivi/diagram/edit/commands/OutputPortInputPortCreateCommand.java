 ...
 * @generated
 */
public class OutputPortInputPortCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPortInputPortCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return PiviBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateOutputPortInputPort_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setInputPort(getTarget());
		}
