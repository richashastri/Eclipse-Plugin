 ...
 * @generated
 */
public class ThreadEndThreadEndFigureCompartmentEditPart extends
	 ...
	 * @generated
	 */
	public ThreadEndThreadEndFigureCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ThreadEndThreadEndFigureCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ThreadEndThreadEndFigureCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ThreadEndThreadEndFigureCompartmentCanonicalEditPolicy());
	}
