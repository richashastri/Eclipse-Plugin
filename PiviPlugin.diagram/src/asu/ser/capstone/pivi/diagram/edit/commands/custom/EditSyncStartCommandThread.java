...
public class EditSyncStartCommandThread implements Runnable {
	...
	public EditSyncStartCommandThread(TransactionalEditingDomain domain, EStructuralFeature feature, EObject modelElement, IWizard wizard) {
		this.domain = domain;
	...
	public void run() {
		...
		org.eclipse.emf.common.command.Command command = SetCommand.create(domain, modelElement,
				feature, ((SyncWizard) wizard).getNewName());
