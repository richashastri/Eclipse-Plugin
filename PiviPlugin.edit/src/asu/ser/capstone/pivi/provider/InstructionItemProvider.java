...
/**
 * This is the item provider adapter for a {@link asu.ser.capstone.pivi.Instruction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instruction_instructions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instruction_instructions_feature", "_UI_Instruction_type"),
				 PiviPackage.Literals.INSTRUCTION__INSTRUCTIONS,
				 true,
				 false,
				 false,
