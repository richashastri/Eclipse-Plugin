...
public class WhileEndCompartmentFigureListener implements FigureListener {
	...
	public WhileEndCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
