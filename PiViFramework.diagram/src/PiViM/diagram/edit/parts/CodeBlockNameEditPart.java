...
public class CodeBlockNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new PiViM.diagram.edit.policies.PiViTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PiViM.diagram.providers.PiViElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PiViM.diagram.providers.PiViParserProvider.getParser(
					PiViM.diagram.providers.PiViElementTypes.CodeBlock_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					PiViM.diagram.edit.parts.PiViEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
