...
public class ThreadStartCompartmentFigureListener implements FigureListener{
	...
	public ThreadStartCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
