...
public class SyncEndRoundedRectangle extends RoundedRectangle{
	
	public SyncEndRoundedRectangle() {
		super();
		setLineWidth(2);
	}
	...
	public void paintFigure(Graphics graphics) {
		...
		graphics.drawLine(new Point(r.x + r.width * 0.3, r.y + r.height * 0.8),
				new Point(r.x + r.width * 0.6, r.y + r.height * 0.6));
		graphics.drawLine(new Point(r.x + r.width * 0.45, r.y + r.height * 0.2),
				new Point(r.x + r.width * 0.45, r.y + r.height * 0.8));
