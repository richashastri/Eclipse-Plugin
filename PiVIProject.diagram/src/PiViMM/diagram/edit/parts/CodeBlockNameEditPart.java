...
public class CodeBlockNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new PiViMM.diagram.edit.policies.PiViTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PiViMM.diagram.providers.PiViElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PiViMM.diagram.providers.PiViParserProvider.getParser(
					PiViMM.diagram.providers.PiViElementTypes.CodeBlock_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					PiViMM.diagram.edit.parts.PiViEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
