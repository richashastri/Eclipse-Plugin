...
public class SyncEndCompartmentFigureListener implements FigureListener {
	...
	public SyncEndCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
