...
import asu.ser.capstone.pivi.diagram.edit.policies.IfStartItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfStartEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IfStartEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IfStartItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new IfStartFigure();
	}

	/**
	 * @generated
	 */
	public IfStartFigure getPrimaryShape() {
		return (IfStartFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IfStartIfStartFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureIfStartFigureCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IfStartIfStartFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IfStartIfStartFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureIfStartFigureCompartment();
			pane.remove(((IfStartIfStartFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof IfStartIfStartFigureCompartmentEditPart) {
	 ...
	 * @generated
	 */
	public class IfStartFigure extends RectangleFigure {
