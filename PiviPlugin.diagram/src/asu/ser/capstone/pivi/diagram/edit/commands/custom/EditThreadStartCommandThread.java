...
public class EditThreadStartCommandThread implements Runnable{
	...
	public EditThreadStartCommandThread(TransactionalEditingDomain domain, EStructuralFeature feature, EObject modelElement, IWizard wizard) {
		this.domain = domain;
	...
	public void run() {
		...
		org.eclipse.emf.common.command.Command command = SetCommand.create(domain, modelElement,
				feature, ((ThreadWizard) wizard).getNewName());
