...
public class PiViBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(PiViMM.diagram.part.PiViVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PiViMM.diagram.providers.PiViElementTypes
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = PiViMM.diagram.part.PiViDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateConnector_4001(PiViMM.Icons container, PiViMM.CodeBlock source,
				PiViMM.CodeBlock target) {
		...
		* @generated
		*/
		public boolean canExistConnector_4001(PiViMM.Icons container, PiViMM.Connector linkInstance,
				PiViMM.CodeBlock source, PiViMM.CodeBlock target) {
			return true;
		}
	}
