...
package SquareMM.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(SquareMM.diagram.part.SquareDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(SquareMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
