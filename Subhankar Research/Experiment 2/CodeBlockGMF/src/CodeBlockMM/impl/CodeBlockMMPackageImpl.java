...
public class CodeBlockMMPackageImpl extends EPackageImpl implements CodeBlockMMPackage {
	 ...
	 * @generated
	 */
	public EReference getArchitecture_Codeblocks() {
	 ...
	 * @generated
	 */
	public EReference getArchitecture_Connections() {
	...
	public void createPackageContents() {
		...
		createEReference(architectureEClass, ARCHITECTURE__CODEBLOCKS);
		createEReference(architectureEClass, ARCHITECTURE__CONNECTIONS);
	...
	public void initializePackageContents() {
		...
		initEReference(getArchitecture_Codeblocks(), this.getCodeBlock(), null, "codeblocks", null, 0, -1, Architecture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArchitecture_Connections(), this.getConnection(), null, "connections", null, 0, -1, Architecture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
