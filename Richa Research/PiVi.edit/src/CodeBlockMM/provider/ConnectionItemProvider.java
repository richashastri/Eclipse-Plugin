...
/**
 * This is the item provider adapter for a {@link CodeBlockMM.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CodeBlockMMPackage.Literals.CONNECTION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_Code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_Code_feature", "_UI_Connection_type"),
				 CodeBlockMMPackage.Literals.CONNECTION__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CodeBlockMMPackage.Literals.CONNECTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CodeBlockMMPackage.Literals.CONNECTION__TARGET,
				 true,
				 false,
				 true,
				 null,
