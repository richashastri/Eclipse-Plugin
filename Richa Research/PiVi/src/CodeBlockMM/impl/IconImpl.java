 ...
 *   <li>{@link CodeBlockMM.impl.IconImpl#getCodeblock <em>Codeblock</em>}</li>
...
public class IconImpl extends MinimalEObjectImpl.Container implements Icon {
	...
	/**
	 * The cached value of the '{@link #getCodeblock() <em>Codeblock</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCodeblock()
	 * @generated
	...
	public EList<CodeBlock> getCodeblock() {
		if (codeblock == null) {
			codeblock = new EObjectContainmentEList<CodeBlock>(CodeBlock.class, this, CodeBlockMMPackage.ICON__CODEBLOCK);
		}
		return codeblock;
	}
