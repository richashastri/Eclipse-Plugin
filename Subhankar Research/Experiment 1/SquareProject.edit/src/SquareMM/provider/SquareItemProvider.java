...
/**
 * This is the item provider adapter for a {@link SquareMM.Square} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Square_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Square_Name_feature", "_UI_Square_type"),
				 SquareMMPackage.Literals.SQUARE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SquareMMPackage.Literals.SQUARE__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Square_Length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Square_Length_feature", "_UI_Square_type"),
				 SquareMMPackage.Literals.SQUARE__LENGTH,
				 true,
				 false,
				 false,
