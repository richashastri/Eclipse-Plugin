 ...
 * @generated
 */
public class IfStartIfStartFigureCompartmentEditPart extends
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IfStartIfStartFigureCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IfStartIfStartFigureCompartmentCanonicalEditPolicy());
	}
