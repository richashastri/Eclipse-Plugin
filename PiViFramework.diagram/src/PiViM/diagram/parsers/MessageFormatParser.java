...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(PiViM.diagram.part.PiViDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(PiViM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
