...
public class EditPrintStatementCommandThread implements Runnable{
	private TransactionalEditingDomain domain;
	private EStructuralFeature feature;
	private EObject modelElement;
	private IWizard wizard;
	
	public EditPrintStatementCommandThread(TransactionalEditingDomain domain, EStructuralFeature feature, EObject modelElement, IWizard wizard) {
		this.domain = domain;
	...
	public void run() {
		...
		org.eclipse.emf.common.command.Command command = SetCommand.create(domain, modelElement,
				feature, ((PrintStatementWizard) wizard).getNewPrintlines());
