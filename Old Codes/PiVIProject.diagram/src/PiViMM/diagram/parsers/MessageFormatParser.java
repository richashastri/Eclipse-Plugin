...
package PiViMM.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(PiViMM.diagram.part.PiViDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(PiViMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
