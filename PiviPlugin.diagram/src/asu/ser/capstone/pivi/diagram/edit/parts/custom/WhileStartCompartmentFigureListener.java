...
public class WhileStartCompartmentFigureListener implements FigureListener {
	...
	public WhileStartCompartmentFigureListener(ListCompartmentEditPart compartmentEditPart, RoundedRectangle roundedRectangle) {
