...
public class InstructionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InstructionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InstructionInstructionFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInstructionFigureCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InstructionInstructionFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InstructionInstructionFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureInstructionFigureCompartment();
			pane.remove(((InstructionInstructionFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
