...
public class CodeBlockMMPackageImpl extends EPackageImpl implements CodeBlockMMPackage {
	 ...
	 * @generated
	 */
	public EReference getIcon_Codeblocks() {
	...
	public void createPackageContents() {
		...
		createEReference(iconEClass, ICON__CODEBLOCKS);
		createEReference(iconEClass, ICON__CONNECTIONS);

		codeblockEClass = createEClass(CODEBLOCK);
		createEAttribute(codeblockEClass, CODEBLOCK__NAME);
		createEAttribute(codeblockEClass, CODEBLOCK__CODE);
	...
	public void initializePackageContents() {
		...
		initEReference(getIcon_Codeblocks(), this.getCodeblock(), null, "codeblocks", null, 1, -1, Icon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
