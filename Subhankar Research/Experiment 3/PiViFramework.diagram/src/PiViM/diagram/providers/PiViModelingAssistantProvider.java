...
public class PiViModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(PiViM.diagram.part.Messages.PiViModelingAssistantProviderMessage);
		dialog.setTitle(PiViM.diagram.part.Messages.PiViModelingAssistantProviderTitle);
